...
- [x] Parse math formulas (x,y,z) using math.js.
- [x] Draw trajectory ghost lines.
- [x] Initialize frontend application (Vite + React).
- [x] Set up Three.js scene with a cube and camera inside.
- [x] Render the turret on the player's wall.
- [x] Create the target wall grid.
- [x] Document project brief, game design, math rules, and architecture.
- [x] Define level progression and reveal system.
